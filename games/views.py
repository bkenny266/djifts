...
def game_view(request, game_id, team):
	...
	results_all = teamgame.get_lines().exclude(line__line_type="O")
	results_f = results_all.filter(line__line_type="F")
	results_d = results_all.filter(line__line_type="D")
	results_pp = results_all.filter(line__line_type="PP")
